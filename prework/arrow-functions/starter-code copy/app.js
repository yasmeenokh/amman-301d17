...
// it refers to the function call. so when we invoke a new Object it refers to the constructor's function by the function call.

// 2. What is "this" when joe.scopeArrow() is invoked?
// it came back as undefined, because the arrow function doesn't apply the constructor's properties.

// 3. Explain why "this" is different when an arrow function is used.
// the constructor's properties/ functions don't apply to the arrow function when using this.
